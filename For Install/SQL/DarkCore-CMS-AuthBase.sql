...
ADD COLUMN rank INT(32) NULL,
ADD COLUMN staff_id INT(32) NULL,
ADD COLUMN vp VARCHAR(50) NULL DEFAULT '0',
ADD COLUMN dp VARCHAR(50) NULL DEFAULT '0',
ADD COLUMN isActive INT(32) NULL,
ADD COLUMN activation VARCHAR(255) NULL,
...
ADD COLUMN foundus VARCHAR(255) NULL,
